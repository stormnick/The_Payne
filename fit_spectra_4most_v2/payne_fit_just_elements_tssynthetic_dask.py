...
if __name__ == '__main__':
    ...
    delayed_rows = [fit_one_spectrum_delayed(f, stellar_rv, true_parameter) for f, true_parameter in zip(files, true_parameters)]
    ...
    fitted_values.to_csv(f"just_elements_fitted_{snr_to_do}.csv", index=False)
