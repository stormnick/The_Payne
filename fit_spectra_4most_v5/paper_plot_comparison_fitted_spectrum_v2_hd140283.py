...
# and 5242.49
    ...
    zoom_regions = [
        [(4290.01, 4329.99), (0.45, 1.02), (5, 1, 0.1, 0.02)],
        #(5166.51, 5184.49),
        [(5166.51, 5174.5), (0.47, 1.02), (2, 0.5, 0.1, 0.02)],
        #(5166.71, 5168.00),
        [(6707.21, 6708.349), (0.82, 1.03), (0.5, 0.1, 0.05, 0.01)],  # Li line
        [(4121.32 - 0.7, 4121.32 + 0.7), (0.83, 1.02), (0.5, 0.1, 0.05, 0.01)],  # Co I
        #(5264.2 - 0.5, 5264.2 + 0.5),  #
        [(5590.1 - 0.72, 5590.1 + 0.7), (0.975, 1.01), (0.3, 0.1, 0.01, 0.005)],  #
    ...
    plt.savefig("../plots/HD140283_4MOST-HR_Payne_fit_v2.pdf", bbox_inches='tight')
    plt.show()