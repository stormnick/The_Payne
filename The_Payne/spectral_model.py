...
def get_spectrum_from_neural_net(scaled_labels, NN_coeffs, kovalev=False, kovalev_alt=False, pixel_limits=None):
    """
    ...
    pixel_limits : None, tuple, or list of tuples
        ...
        - If pixel_limits is a boolean array, it is used to select pixels. E.g. [True, False, True] would mean that the
    ...
    # If pixel_limits is a boolean array, it is used to select pixels.
