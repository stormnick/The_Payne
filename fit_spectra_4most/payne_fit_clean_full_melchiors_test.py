...
from payne_fit_clean_full import fit_teff, fit_logg, fit_feh, fit_one_xfe_element, process_spectra, load_payne, fit_teff_logg
...
if __name__ == '__main__':
    ...
    for file in files:
        ...
        fitted_values.to_csv("fitted_values_melchiors_v2_test.csv", index=False)
